...
class AdminController extends Controller
{
    ...
    public function ThemeSettings(){
        $fonts = new FontFamily();
        $fonts->title = 'Abril Fatface';
        $fonts->name = 'Abril Fatface';
        $fonts->save();
        $fonts->title = 'Amatic SC';
        $fonts->name = 'Amatic SC';
        $fonts->save();
        $fonts->title = 'Bangers';
        $fonts->name = 'Bangers';
        $fonts->save();
        ...
        $fonts->name = 'Caveat';
        $fonts->save();
        $fonts->title = 'Courgette';
        $fonts->name = 'Courgette';
        $fonts->save();
        $fonts->title = 'Indie Flower';
        $fonts->name = 'Indie Flower';
        $fonts->save();
        $fonts->title = 'Kaushan Script';
        $fonts->name = 'Kaushan Script';
        $fonts->save();
        $fonts->title = 'Lobster';
        $fonts->name = 'Lobster';
        $fonts->save();
        $fonts->title = 'Lobster Two';
        $fonts->name = 'Lobster Two';
        $fonts->save();
        $fonts->title = 'Montserrat';
        $fonts->name = 'Montserrat';
        $fonts->save();
        $fonts->title = 'Open Sans';
        $fonts->name = 'Open Sans';
        $fonts->save();
        $fonts->title = 'Orbitron';
        $fonts->name = 'Orbitron';
        $fonts->save();
        $fonts->title = 'Pacifico';
        $fonts->name = 'Pacifico';
        $fonts->save();
        $fonts->title = 'Patrick Hand';
        $fonts->name = 'Patrick Hand';
        $fonts->save();
        $fonts->title = 'Rajdhani';
        $fonts->name = 'Rajdhani';
        $fonts->save();
        $fonts->title = 'Raleway';
        $fonts->name = 'Raleway';
        $fonts->save();
        $fonts->title = 'Righteous';
        $fonts->name = 'Righteous';
        $fonts->save();
        $fonts->title = 'Roboto';
        $fonts->name = 'Roboto';
        $fonts->save();
        $fonts->title = 'Sacramento';
        $fonts->name = 'Sacramento';
        $fonts->save();
        $fonts->title = 'Sacramento';
        $fonts->name = 'Sacramento';
        $fonts->save();
